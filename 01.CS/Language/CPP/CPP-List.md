...
- [2022-C++ 语言参考 #Series#](https://learn.microsoft.com/zh-cn/cpp/cpp/cpp-language-reference?view=msvc-170): 本参考将介绍在 Microsoft C++ 编译器中实现的 C++ 编程语言。 本文的结构基于 Margaret Ellis 和 Bjarne Stroustrup 撰写的《C++ 参考手册批注》和 ANSI/ISO C++ 国际标准 (ISO/IEC FDIS 14882)。 本文涵盖了 C++ 语言功能的 Microsoft 专用实现。
