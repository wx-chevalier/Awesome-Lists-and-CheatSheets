...
- [2016_Shell 编程之执行过程](https://parg.co/UT0)
...
- [2017_Linux 下容易被忽视的那些命令用法](https://parg.co/b2E)
...
- [2018_pure bash bible](https://github.com/dylanaraps/pure-bash-bible): The goal of this book is to document known and unknown methods of doing various tasks using only built-in bash features.
